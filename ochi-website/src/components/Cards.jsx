...
function Cards() {
  ...
  return (
    <div className="w-full h-screen flex gap-4 bg-zinc-900 px-4 py-1">
      <div className="relative w-1/3 h-[62vh] flex justify-center items-center border-[1px] border-[#ceea6832] bg-[#004D43] rounded-xl hover:scale-95 transition-transform duration-300 ease-in-out">
        <svg
        ...
        <button className="absolute border-[1px] border-[#CDEA68] text-[#CDEA68] text-sm font-smaller px-3 py-1 bottom-7 left-7 rounded-full">
          &copy;2019-2022
        </button>
      </div>
      <div className="relative w-1/3 h-[62vh] flex justify-center items-center border-[1px] border-zinc-700 bg-[#252525] rounded-xl hover:scale-95 transition-transform duration-300 ease-in-out">
        <img
          className="hover:scale-110 transition-transform duration-300 ease-in-out"
          ...
          width={"145px"}
        />
        <button className="absolute z-999 border-[1px] border-[#fff] text-[#fff] text-sm font-smaller px-3 py-1 bottom-7 left-7 rounded-full ">
          RATING 5.0 ON CLUTCH
        </button>
      </div>
      <div className="relative w-1/3 h-[62vh] flex justify-center items-center border-[1px] border-zinc-700 bg-[#212121] rounded-xl hover:scale-95 transition-transform duration-300 ease-in-out">
        <img
          className="hover:scale-110 transition-transform duration-300 ease-in-out"
